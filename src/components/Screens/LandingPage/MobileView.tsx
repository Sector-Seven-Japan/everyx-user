  ...
  return (
    <>
      <div className="bg-[#0E0E0E] w-full min-h-screen py-10">
        ...
        <div className="mt-16 relative h-[200px] sm:h-[300px]">
          <Image
        ...
        <div className="pt-10 px-4 sm:px-10 flex justify-center items-center gap-2 flex-wrap">
        ...
        <div className="mt-1 relative h-[300px] sm:h-[650px] w-full">
          <Image
        ...
        <div className="mt-1 relative h-[200px] sm:h-[300px] w-full">
          <Image
        ...
        <div className="relative mt-1 h-[300px] sm:h-[600px] w-full">
          <Image
        ...
        <div className="mt-10 px-4 sm:px-10 flex justify-center items-center flex-col">
