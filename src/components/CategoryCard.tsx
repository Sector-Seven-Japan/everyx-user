  ...
  return (
    <div className="rounded-xl overflow-hidden cursor-pointer">
      ...
      <div className="flex mt-3 gap-3 md:mt-2 items-center">
        ...
        <p className="text-[#00FFB8] md:text-[10px]">
      ...
      >
        <div className={`w-1/2 px-4 py-3 bg-[#131313] rounded-md`}>
          <p className="text-[#2DC198] text-[24px] font-light md:text-[12px]">
        ...
        <div
          className={`w-1/2 px-4 py-3 bg-[#131313] rounded-md`}
        >
          <p className="text-[#2DC198] text-[24px] font-light md:text-[12px]">
          ...
          <div className={`${!showPrediction && "hidden"} md:mt-5`}>
            {item?.outcomes.map((outcome: Outcome, index: number) => (
              <div key={outcome._id} className={`flex flex-col gap-1 md:gap-1`}>
                ...
                <div className="flex justify-between items-center gap-2 md:gap-0 md:mb-2">
                  <div
