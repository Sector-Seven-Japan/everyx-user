  ...
  return (
    <div className="px-5 mt-10">
      ...
      <p className={`text-[15px] font-light text-[#adadad] ${expanded ? "" : "line-clamp-6 overflow-hidden"}`}>
        ...
        2) An armistice, ceasefire, or negotiated settlement is announced by boh Ukraine and Russia regarding the ongoing war in Ukraine at any point between the Associated Press calling the election
        ...
        this market will immediately resolve to &quot;No&quot;. The resolution source for Trump winning the presidency is the Associated Press, Fox News, and NBC.
        This portion of the market will resolve once all three sources call the race for the same candidate. If all three sources haven&apos;t called the
