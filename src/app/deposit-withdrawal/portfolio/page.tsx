    ...
    <>
      ...
      {isMobile ? (
        <div className="bg-[#0E0E0E] w-full min-h-screen text-white px-5 pt-4 pb-5">
          ...
          <div
            className={`w-24 flex flex-col absolute right-10 mt-3 ${open ? "block" : "hidden"
              }`}
          >
            <div
              onClick={() => {
            ...
            <div className="flex justify-between items-start">
              <div className="flex items-start gap-4">
                ...
                <div className="flex flex-col items-end  gap-2">
                  ...
                  <div
                    className={`w-24 flex flex-col  right-10  ${open ? "block" : "hidden"
                      }`}
                  >
                    <div
                      className={`w-24 flex flex-col  right-10  ${open ? "block" : "hidden"
              ...
              <div className="max-w-full mx-auto space-y-8 mt-24">
                {filteredBets.length > 0 ? (
                  filteredBets.map((bet) => {
                    const isExpired = new Date(bet.ends_at) < new Date();
